...
const initialState: BlogState = {
  blogPosts: [
    new BlogPost( 0,'Beachfront Bliss Awaits', 'Rob', new Date(), ['https://blog.beactivetv.pl/wp-content/uploads/2019/07/sean-o-KMn4VEeEPR8-unsplash-1.jpg'],
     [
    ...
    new BlogPost( 1,'Second Post', 'Anna', new Date(), ['https://homegarden.com.pl/media/cache/original/c2977f93f7937b51fb95d49c92272ff9086b39cd.jpeg'], ['dfsdfsdfdsfsgdf']),
    new BlogPost( 2,'Third Post', 'Rob', new Date(), ['https://www.spoon-restaurant.com/wp-content/uploads/2022/06/Spoon_cLe_Bonbon-1-scaled.jpg'], ['dfsdfsdfdsfsgdf'])
  ],
